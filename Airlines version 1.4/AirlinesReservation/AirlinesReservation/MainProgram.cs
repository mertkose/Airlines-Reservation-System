...
namespace AirlinesReservation
{
    public partial class MainProgram : Form
    {
        ...
        {
            UpdateProfile up = new UpdateProfile(UserId);
            up.ShowDialog();
        }

        private void applyTicketToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ApplyTicket at = new ApplyTicket(UserId);
            at.ShowDialog();
        }
    }
}
