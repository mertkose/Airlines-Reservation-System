...
namespace AirlinesReservation
{
    public partial class Main : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Availability ablty = new Availability(UserId,dateTimePicker1.Value, comboBox1.Text, comboBox3.Text, 1);
                ablty.ShowDialog();
            }
            else
            {
            ...
            {
                Availability ablty = new Availability(UserId,dateTimePicker1.Value, dateTimePicker2.Value, comboBox1.Text, comboBox2.Text, comboBox3.Text);
                ablty.ShowDialog();
            }
            }
        }
